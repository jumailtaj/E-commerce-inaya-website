...
export function ProfilePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Profile - Inaya</title>
        <meta name="description" content="Manage your Inaya account and view your orders." />
      </Helmet>
              ...
              <div className="bg-white rounded-sm shadow-sm border border-pink-50 overflow-hidden">
                ...
                <nav className="p-2">
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm text-sm font-medium transition-colors ${activeTab === 'profile' ? 'bg-pink-600 text-white shadow-md' : 'text-gray-600 hover:bg-pink-50'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm text-sm font-medium transition-colors ${activeTab === 'addresses' ? 'bg-pink-600 text-white shadow-md' : 'text-gray-600 hover:bg-pink-50'
                      }`}
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {user.addresses?.length === 0 ? (
                        ...
                        user.addresses?.map((addr) => (
                          <div
                            key={addr._id}
                            className={`relative p-5 rounded-sm border transition-all ${addr.isDefault ? 'border-pink-500 bg-pink-50/30' : 'border-gray-100 bg-white hover:border-pink-200'
                              }`}
                          >
                            {addr.isDefault && (
