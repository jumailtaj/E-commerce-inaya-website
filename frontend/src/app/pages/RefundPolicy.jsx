      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-pink-100">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-4xl font-serif text-gray-900">Refund Policy</h1>
          </div>

          <div className="prose prose-pink max-w-none text-gray-600 space-y-6">
            <section>
              <h2 className="text-2xl font-serif text-gray-800 mb-4">1. Return Eligibility</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-serif text-gray-800 mb-4">2. Non-returnable Items</h2>
            ...
            <section>
              <h2 className="text-2xl font-serif text-gray-800 mb-4">3. Refund Process</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-serif text-gray-800 mb-4">4. Late or Missing Refunds</h2>
              <p>
