...
export function Hero() {
  return (
    <div className="relative bg-gradient-to-r from-pink-100 via-white to-pink-50 py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <Link
            to="#products"
            className="inline-block bg-pink-600 text-white px-8 py-4 rounded-full font-medium text-lg hover:bg-pink-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            onClick={(e) => {
              e.preventDefault();
