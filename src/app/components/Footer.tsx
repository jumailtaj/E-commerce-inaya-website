    ...
    <footer className="bg-pink-50 border-t border-pink-100 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-serif text-pink-600 mb-4">ClipChic</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/admin" className="text-gray-600 hover:text-pink-600 transition-colors">Admin</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-600 hover:text-pink-600 transition-colors">Pinterest</a></li>
              <li><a href="#" className="text-gray-600 hover:text-pink-600 transition-colors">TikTok</a></li>
            </ul>
          </div>
        </div>

        <div className="mt-12 pt-8 border-t border-pink-200 text-center text-sm text-gray-600">
          <p>&copy; 2026 ClipChic. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
